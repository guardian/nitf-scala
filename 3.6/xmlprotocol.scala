...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit val fromAnySchemaType: scala.xml.Elem => Option[scalaxb.DataRecord[Any]] = {elem =>
    ...
    (key, ns) match {
      case (Some("nitf-col"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NitfCol](elem)))
      case (Some("nitf-table-summary"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NitfTableSummary](elem)))
      case (Some("table-reference"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.TableReference](elem)))
      case (Some("nitf-table"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NitfTable](elem)))
      case (Some("bibliography"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Bibliography](elem)))
      case (Some("body.end"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.BodyEnd](elem)))
      case (Some("postcode"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Postcode](elem)))
      case (Some("care.of"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.CareOf](elem)))
      case (Some("q"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Q](elem)))
      case (Some("lang"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Lang](elem)))
      case (Some("br"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Br](elem)))
      case (Some("virtloc"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Virtloc](elem)))
      case (Some("name.family"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NameFamily](elem)))
      case (Some("person"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Person](elem)))
      case (Some("org"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Org](elem)))
      case (Some("sup"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Sup](elem)))
      case (Some("denom"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Denom](elem)))
      case (Some("numer"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Numer](elem)))
      case (Some("num"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Num](elem)))
      case (Some("country"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Country](elem)))
      case (Some("state"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.State](elem)))
      case (Some("sublocation"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Sublocation](elem)))
      case (Some("function"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.FunctionType](elem)))
      case (Some("chron"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Chron](elem)))
      case (Some("th"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Th](elem)))
      case (Some("tfoot"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Tfoot](elem)))
      case (Some("thead"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Thead](elem)))
      case (Some("col"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Col](elem)))
      case (Some("datasource"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Datasource](elem)))
      case (Some("pre"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Pre](elem)))
      case (Some("credit"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Credit](elem)))
      case (Some("dd"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Dd](elem)))
      case (Some("dl"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Dl](elem)))
      case (Some("ul"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Ul](elem)))
      case (Some("media-producer"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.MediaProducer](elem)))
      case (Some("media-object"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.MediaObject](elem)))
      case (Some("media-reference"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.MediaReference](elem)))
      case (Some("table"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Table](elem)))
      case (Some("block"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Block](elem)))
      case (Some("copyrite.holder"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.CopyriteHolder](elem)))
      case (Some("copyrite"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Copyrite](elem)))
      case (Some("story.date"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.StoryDate](elem)))
      case (Some("distributor"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Distributor](elem)))
      case (Some("byline"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Byline](elem)))
      case (Some("rights.type"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsType](elem)))
      case (Some("rights.agent"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsAgent](elem)))
      case (Some("rights.startdate"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsStartdate](elem)))
      case (Some("rights"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Rights](elem)))
      case (Some("hl2"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Hl2](elem)))
      case (Some("hedline"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Hedline](elem)))
      case (Some("body"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Body](elem)))
      case (Some("pubdata"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Pubdata](elem)))
      case (Some("keyword"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Keyword](elem)))
      case (Some("doc.rights"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DocRights](elem)))
      case (Some("du-key"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DuKey](elem)))
      case (Some("series"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Series](elem)))
      case (Some("date.expire"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DateExpire](elem)))
      case (Some("date.issue"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DateIssue](elem)))
      case (Some("urgency"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Urgency](elem)))
      case (Some("del-list"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DelList](elem)))
      case (Some("evloc"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Evloc](elem)))
      case (Some("docdata"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Docdata](elem)))
      case (Some("iim"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Iim](elem)))
      case (Some("tobject.property"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.TobjectProperty](elem)))
      case (Some("meta"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Meta](elem)))
      case (Some("head"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Head](elem)))
      case (Some("nitf"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Nitf](elem)))
      case (Some("title"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Title](elem)))
      case (Some("tobject"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Tobject](elem)))
      case (Some("tobject.subject"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.TobjectSubject](elem)))
      case (Some("ds"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Ds](elem)))
      case (Some("correction"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Correction](elem)))
      case (Some("doc-id"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DocId](elem)))
      case (Some("from-src"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.FromSrc](elem)))
      case (Some("fixture"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Fixture](elem)))
      case (Some("date.release"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DateRelease](elem)))
      case (Some("doc-scope"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DocScope](elem)))
      case (Some("ed-msg"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.EdMsg](elem)))
      case (Some("doc.copyright"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DocCopyright](elem)))
      case (Some("key-list"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.KeyList](elem)))
      case (Some("identified-content"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.IdentifiedContent](elem)))
      case (Some("revision-history"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RevisionHistory](elem)))
      case (Some("body.head"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.BodyHead](elem)))
      case (Some("hl1"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Hl1](elem)))
      case (Some("note"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Note](elem)))
      case (Some("rights.owner"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsOwner](elem)))
      case (Some("rights.enddate"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsEnddate](elem)))
      case (Some("rights.geography"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsGeography](elem)))
      case (Some("rights.limitations"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.RightsLimitations](elem)))
      case (Some("byttl"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Byttl](elem)))
      case (Some("dateline"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Dateline](elem)))
      case (Some("abstract"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Abstract](elem)))
      case (Some("copyrite.year"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.CopyriteYear](elem)))
      case (Some("body.content"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.BodyContent](elem)))
      case (Some("p"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.P](elem)))
      case (Some("media"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Media](elem)))
      case (Some("media-metadata"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.MediaMetadata](elem)))
      case (Some("media-caption"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.MediaCaption](elem)))
      case (Some("ol"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Ol](elem)))
      case (Some("li"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Li](elem)))
      case (Some("dt"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Dt](elem)))
      case (Some("bq"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Bq](elem)))
      case (Some("fn"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Fn](elem)))
      case (Some("hr"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Hr](elem)))
      case (Some("caption"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Caption](elem)))
      case (Some("colgroup"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Colgroup](elem)))
      case (Some("tbody"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Tbody](elem)))
      case (Some("tr"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Tr](elem)))
      case (Some("td"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Td](elem)))
      case (Some("event"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Event](elem)))
      case (Some("location"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Location](elem)))
      case (Some("city"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.City](elem)))
      case (Some("region"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Region](elem)))
      case (Some("money"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Money](elem)))
      case (Some("frac"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Frac](elem)))
      case (Some("frac-sep"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.FracSep](elem)))
      case (Some("sub"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Sub](elem)))
      case (Some("object.title"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.ObjectTitle](elem)))
      case (Some("alt-code"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.AltCode](elem)))
      case (Some("name.given"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NameGiven](elem)))
      case (Some("postaddr"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Postaddr](elem)))
      case (Some("a"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.A](elem)))
      case (Some("em"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Em](elem)))
      case (Some("pronounce"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Pronounce](elem)))
      case (Some("addressee"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Addressee](elem)))
      case (Some("delivery.point"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DeliveryPoint](elem)))
      case (Some("delivery.office"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.DeliveryOffice](elem)))
      case (Some("tagline"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Tagline](elem)))
      case (Some("classifier"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.Classifier](elem)))
      case (Some("custom-table"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.CustomTable](elem)))
      case (Some("nitf-table-metadata"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NitfTableMetadata](elem)))
      case (Some("nitf-colgroup"), Some("http://iptc.org/std/NITF/2006-10-18/") | None) => Some(DataRecord(ns, key, xsns, xstype, fromXML[com.gu.nitf.model.NitfColgroup](elem)))
  ...
  trait DefaultComgunitfmodel_NitfFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Nitf] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[com.gu.nitf.model.Nitf] =
      ...
      safeRep(any(_.namespace != Some("http://iptc.org/std/NITF/2006-10-18/"))) ^^
      { case p1 ~ p2 ~ p3 =>
      com.gu.nitf.model.Nitf(p1.headOption map { scalaxb.fromXML[com.gu.nitf.model.Head](_, scalaxb.ElemName(node) :: stack) },
        ...
        Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[String](scala.xml.Text("-//IPTC//DTD NITF 3.6//EN"), scalaxb.ElemName(node) :: stack))) map { "@version" -> _ },
        Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[String](scala.xml.Text("September 11, 2009"), scalaxb.ElemName(node) :: stack))) map { "@change.date" -> _ },
        Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[String](scala.xml.Text("12:26"), scalaxb.ElemName(node) :: stack))) map { "@change.time" -> _ },
        ...
        (node \ "@class").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[Seq[String]](x, scalaxb.ElemName(node) :: stack)) } map { "@class" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "uno" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "version" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "change.date" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "change.time" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "baselang" => Nil
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Nitf, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.head map { scalaxb.toXML[com.gu.nitf.model.Head](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("head"), __scope, false) } getOrElse {Nil},
        scalaxb.toXML[com.gu.nitf.model.Body](__obj.body, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("body"), __scope, false),
  ...
  trait DefaultComgunitfmodel_HeadFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Head] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[com.gu.nitf.model.Head] =
      ...
      com.gu.nitf.model.Head(p1.headOption map { scalaxb.fromXML[com.gu.nitf.model.Title](_, scalaxb.ElemName(node) :: stack) },
        ...
        p8 map { scalaxb.fromXML[scalaxb.DataRecord[Any]](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
        (node \ "@id").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@id" -> _ }
        ).flatten[(String, scalaxb.DataRecord[Any])] ::: (node match {
          case elem: scala.xml.Elem =>
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Head, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.title map { scalaxb.toXML[com.gu.nitf.model.Title](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("title"), __scope, false) } getOrElse {Nil},
        __obj.meta flatMap { scalaxb.toXML[com.gu.nitf.model.Meta](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("meta"), __scope, false) },
        __obj.tobject map { scalaxb.toXML[com.gu.nitf.model.Tobject](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tobject"), __scope, false) } getOrElse {Nil},
        __obj.iim map { scalaxb.toXML[com.gu.nitf.model.Iim](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("iim"), __scope, false) } getOrElse {Nil},
        __obj.docdata map { scalaxb.toXML[com.gu.nitf.model.Docdata](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("docdata"), __scope, false) } getOrElse {Nil},
        __obj.pubdata flatMap { scalaxb.toXML[com.gu.nitf.model.Pubdata](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("pubdata"), __scope, false) },
        __obj.revisionHistory flatMap { scalaxb.toXML[com.gu.nitf.model.RevisionHistory](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("revision-history"), __scope, false) },
        __obj.any flatMap { x => scalaxb.toXML[scalaxb.DataRecord[Any]](x, x.namespace, x.key, __scope, true) })
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Meta(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@content").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@content" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "http-equiv" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "content" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_TobjectFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Tobject] {
      ...
      com.gu.nitf.model.Tobject(p1 map { scalaxb.fromXML[com.gu.nitf.model.TobjectProperty](_, scalaxb.ElemName(node) :: stack) },
        ...
        (node \ "@tobject.type").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } orElse Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[String](scala.xml.Text("news"), scalaxb.ElemName(node) :: stack))) map { "@tobject.type" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Tobject, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.tobjectProperty flatMap { scalaxb.toXML[com.gu.nitf.model.TobjectProperty](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tobject.property"), __scope, false) },
        __obj.tobjectSubject flatMap { scalaxb.toXML[com.gu.nitf.model.TobjectSubject](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tobject.subject"), __scope, false) })
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.TobjectProperty(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@tobject.property.type").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } orElse Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[String](scala.xml.Text("current"), scalaxb.ElemName(node) :: stack))) map { "@tobject.property.type" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.property.type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.TobjectSubject(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@tobject.subject.detail").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@tobject.subject.detail" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.subject.ipr" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.subject.refnum" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.subject.code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.subject.type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.subject.matter" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tobject.subject.detail" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_IimFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Iim] {
      ...
      com.gu.nitf.model.Iim(p1 map { scalaxb.fromXML[com.gu.nitf.model.Ds](_, scalaxb.ElemName(node) :: stack) },
        ...
        (node \ "@ver").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@ver" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "ver" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Iim, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.ds flatMap { scalaxb.toXML[com.gu.nitf.model.Ds](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("ds"), __scope, false) })
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Ds(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@value").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@value" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "num" => Nil
  ...
  trait DefaultComgunitfmodel_DocdataFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Docdata] {
      ...
      com.gu.nitf.model.Docdata(p1,
        ...
        (node \ "@management-idref-status").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@management-idref-status" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "management-status" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "management-doc-idref" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "management-idref-status" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Docdata, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.docdataoption flatMap { x => scalaxb.toXML[scalaxb.DataRecord[Any]](x, x.namespace, x.key, __scope, false) })
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Correction(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@regsrc").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@regsrc" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "info" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id-string" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "regsrc" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Evloc(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@city").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@city" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "iso-cc" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "state-prov" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "county-dist" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "city" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_DelListSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.DelListSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.DelListSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      scalaxb.toXML[com.gu.nitf.model.FromSrc](__obj.fromSrc, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("from-src"), __scope, false)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.FromSrc(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@level-number").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@level-number" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "src-name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "level-number" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Urgency(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@ed-urg").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@ed-urg" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "ed-urg" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Fixture(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@fix-id").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@fix-id" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "fix-id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.DateIssue(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@norm").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@norm" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "norm" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.DocScope(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@scope").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@scope" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "scope" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.Series(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@series.totalpart").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } orElse Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[String](scala.xml.Text("0"), scalaxb.ElemName(node) :: stack))) map { "@series.totalpart" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "series.name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "series.part" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "series.totalpart" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.EdMsg(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@info").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@info" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "msg-type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "info" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.DuKey(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@key").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@key" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "generation" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "part" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "version" => Nil
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.DocCopyright(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@holder").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@holder" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "year" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "holder" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.DocRights(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@limitations").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@limitations" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "owner" => Nil
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "agent" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "geography" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "location-code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "code-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "limitations" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_KeyListSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.KeyListSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.KeyListSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      scalaxb.toXML[com.gu.nitf.model.Keyword](__obj.keyword, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("keyword"), __scope, false)
        ...
        (node \ "@ex-ref").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@ex-ref" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "item-length" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "unit-of-measure" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "date.publication" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "issn" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "volume" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "number" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "issue" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "edition.name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "edition.area" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "position.section" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "position.sequence" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "ex-ref" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
        ...
        (node \ "@comment").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@comment" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "function" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "norm" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "comment" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_BodyFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Body] {
        ...
        (node \ "@{http://www.w3.org/XML/1998/namespace}lang").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@{http://www.w3.org/XML/1998/namespace}lang" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "class" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "style" => Nil
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Body, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.bodyHead map { scalaxb.toXML[com.gu.nitf.model.BodyHead](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("body.head"), __scope, false) } getOrElse {Nil},
        __obj.bodyContent flatMap { scalaxb.toXML[com.gu.nitf.model.BodyContent](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("body.content"), __scope, false) },
        __obj.bodyEnd map { scalaxb.toXML[com.gu.nitf.model.BodyEnd](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("body.end"), __scope, false) } getOrElse {Nil})
  ...
  trait DefaultComgunitfmodel_BodyHeadFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.BodyHead] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[com.gu.nitf.model.BodyHead] =
      ...
      com.gu.nitf.model.BodyHead(p1 map { scalaxb.fromXML[com.gu.nitf.model.Hedline](_, scalaxb.ElemName(node) :: stack) },
        ...
        p7 map { scalaxb.fromXML[com.gu.nitf.model.Abstract](_, scalaxb.ElemName(node) :: stack) },
        p8.headOption map { scalaxb.fromXML[com.gu.nitf.model.Series](_, scalaxb.ElemName(node) :: stack) },
        p9 map { scalaxb.fromXML[scalaxb.DataRecord[Any]](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
        (node \ "@id").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@id" -> _ }
        ).flatten[(String, scalaxb.DataRecord[Any])] ::: (node match {
          case elem: scala.xml.Elem =>
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.BodyHead, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.hedline flatMap { scalaxb.toXML[com.gu.nitf.model.Hedline](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("hedline"), __scope, false) },
        __obj.note flatMap { scalaxb.toXML[com.gu.nitf.model.Note](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("note"), __scope, false) },
        __obj.rights map { scalaxb.toXML[com.gu.nitf.model.Rights](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("rights"), __scope, false) } getOrElse {Nil},
        __obj.byline flatMap { scalaxb.toXML[com.gu.nitf.model.Byline](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("byline"), __scope, false) },
        __obj.distributor map { scalaxb.toXML[com.gu.nitf.model.Distributor](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("distributor"), __scope, false) } getOrElse {Nil},
        __obj.dateline flatMap { scalaxb.toXML[com.gu.nitf.model.Dateline](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("dateline"), __scope, false) },
        __obj.abstractValue flatMap { scalaxb.toXML[com.gu.nitf.model.Abstract](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("abstract"), __scope, false) },
        __obj.series map { scalaxb.toXML[com.gu.nitf.model.Series](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("series"), __scope, false) } getOrElse {Nil},
        __obj.any flatMap { x => scalaxb.toXML[scalaxb.DataRecord[Any]](x, x.namespace, x.key, __scope, true) })
  ...
  trait DefaultComgunitfmodel_HedlineFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Hedline] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Hedline, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[com.gu.nitf.model.Hl1](__obj.hl1, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("hl1"), __scope, false),
        __obj.hl2 flatMap { scalaxb.toXML[com.gu.nitf.model.Hl2](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("hl2"), __scope, false) })
        ...
        (node \ "@type").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[com.gu.nitf.model.TypeType2](x, scalaxb.ElemName(node) :: stack)) } orElse Some(scalaxb.DataRecord(None, None, scalaxb.fromXML[com.gu.nitf.model.TypeType2](scala.xml.Text("std"), scalaxb.ElemName(node) :: stack))) map { "@type" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "noteclass" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
  ...
  trait DefaultComgunitfmodel_NoteSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.NoteSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.NoteSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      scalaxb.toXML[com.gu.nitf.model.BodyContent](__obj.bodyContent, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("body.content"), __scope, false)
      ...
      com.gu.nitf.model.RightsOwner(Seq.concat(p1.toList),
        ...
        (node \ "@contact").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@contact" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "contact" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_BlockSequence2Format extends scalaxb.XMLFormat[com.gu.nitf.model.BlockSequence2] {
    ...
    def writes(__obj: com.gu.nitf.model.BlockSequence2, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      __obj.datasource map { scalaxb.toXML[com.gu.nitf.model.Datasource](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("datasource"), __scope, false) } getOrElse {Nil}
  ...
  trait DefaultComgunitfmodel_BlockSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.BlockSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.BlockSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      Seq.concat(__obj.tobject map { scalaxb.toXML[com.gu.nitf.model.Tobject](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tobject"), __scope, false) } getOrElse {Nil},
        __obj.keyList map { scalaxb.toXML[com.gu.nitf.model.KeyList](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("key-list"), __scope, false) } getOrElse {Nil},
        __obj.classifier flatMap { scalaxb.toXML[com.gu.nitf.model.Classifier](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("classifier"), __scope, false) },
        __obj.byline map { scalaxb.toXML[com.gu.nitf.model.Byline](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("byline"), __scope, false) } getOrElse {Nil},
        __obj.dateline map { scalaxb.toXML[com.gu.nitf.model.Dateline](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("dateline"), __scope, false) } getOrElse {Nil},
        __obj.copyrite map { scalaxb.toXML[com.gu.nitf.model.Copyrite](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("copyrite"), __scope, false) } getOrElse {Nil},
        __obj.abstractValue flatMap { scalaxb.toXML[com.gu.nitf.model.Abstract](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("abstract"), __scope, false) })
        ...
        (node \ "@optional-text").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@optional-text" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "lede" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "summary" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "optional-text" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_TableFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Table] {
        ...
        (node \ "@cellpadding").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@cellpadding" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "tabletype" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "align" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "width" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "cols" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "border" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "frame" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "rules" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "cellspacing" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "cellpadding" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Table, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.caption map { scalaxb.toXML[com.gu.nitf.model.Caption](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("caption"), __scope, false) } getOrElse {Nil},
        ...
        __obj.thead map { scalaxb.toXML[com.gu.nitf.model.Thead](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("thead"), __scope, false) } getOrElse {Nil},
        __obj.tfoot map { scalaxb.toXML[com.gu.nitf.model.Tfoot](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tfoot"), __scope, false) } getOrElse {Nil},
  ...
  trait DefaultComgunitfmodel_MediaFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Media] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[com.gu.nitf.model.Media] =
      ...
      safeRep(scalaxb.ElemName(Some("http://iptc.org/std/NITF/2006-10-18/"), "media-producer")) ~ 
      safeRep(any(_.namespace != Some("http://iptc.org/std/NITF/2006-10-18/"))) ^^
      { case p1 ~ p2 ~ p3 ~ p4 ~ p5 =>
      com.gu.nitf.model.Media(p1 map { scalaxb.fromXML[com.gu.nitf.model.MediaMetadata](_, scalaxb.ElemName(node) :: stack) },
        ...
        p4 map { scalaxb.fromXML[com.gu.nitf.model.MediaProducer](_, scalaxb.ElemName(node) :: stack) },
        p5 map { scalaxb.fromXML[scalaxb.DataRecord[Any]](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
        (node \ "@id").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@id" -> _ },
        (node \ "@class").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@class" -> _ },
        (node \ "@style").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@style" -> _ },
        ...
        (node \ "@media-type").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@media-type" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "media-type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Media, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.mediaMetadata flatMap { scalaxb.toXML[com.gu.nitf.model.MediaMetadata](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-metadata"), __scope, false) },
        __obj.mediasequence1 flatMap { scalaxb.toXML[com.gu.nitf.model.MediaSequence1](_, None, Some("mediasequence1"), __scope, false) },
        __obj.mediaCaption flatMap { scalaxb.toXML[com.gu.nitf.model.MediaCaption](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-caption"), __scope, false) },
        __obj.mediaProducer flatMap { scalaxb.toXML[com.gu.nitf.model.MediaProducer](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-producer"), __scope, false) },
        __obj.any flatMap { x => scalaxb.toXML[scalaxb.DataRecord[Any]](x, x.namespace, x.key, __scope, true) })
  ...
  trait DefaultComgunitfmodel_MediaSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.MediaSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.MediaSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      Seq.concat(scalaxb.toXML[com.gu.nitf.model.MediaReference](__obj.mediaReference, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-reference"), __scope, false),
        __obj.mediaObject map { scalaxb.toXML[com.gu.nitf.model.MediaObject](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-object"), __scope, false) } getOrElse {Nil})
        ...
        (node \ "@data-location").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@data-location" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "mime-type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "coding" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "time" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "time-unit-of-measure" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "outcue" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "source-credit" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "copyright" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "alternate-text" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "height" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "width" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "units" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "imagemap" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "noflow" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "data-location" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
        ...
        (node \ "@seqnum").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@seqnum" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "seqnum" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_OlSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.OlSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.OlSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      scalaxb.toXML[com.gu.nitf.model.Li](__obj.li, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("li"), __scope, false)
        ...
        (node \ "@quote-source").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@quote-source" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "nowrap" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "quote-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_BqSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.BqSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.BqSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      Seq.concat(__obj.block flatMap { scalaxb.toXML[com.gu.nitf.model.Block](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("block"), __scope, false) },
        __obj.credit map { scalaxb.toXML[com.gu.nitf.model.Credit](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("credit"), __scope, false) } getOrElse {Nil})
        ...
        (node \ "@valign").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[com.gu.nitf.model.Valign](x, scalaxb.ElemName(node) :: stack)) } map { "@valign" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "span" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "width" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "align" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "char" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "charoff" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "valign" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_ColgroupFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Colgroup] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Colgroup, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.col flatMap { scalaxb.toXML[com.gu.nitf.model.Col](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("col"), __scope, false) })
  ...
  trait DefaultComgunitfmodel_TheadFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Thead] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Thead, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.tr flatMap { scalaxb.toXML[com.gu.nitf.model.Tr](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tr"), __scope, false) })
        ...
        (node \ "@valign").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[com.gu.nitf.model.Valign](x, scalaxb.ElemName(node) :: stack)) } map { "@valign" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "axis" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "axes" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "nowrap" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "rowspan" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "colspan" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "align" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "char" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "charoff" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "valign" => Nil
        ...
        (node \ "@value").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@value" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "start-date" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "end-date" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "idsrc" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "value" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
        ...
        (node \ "@code-source").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@code-source" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "city-code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "code-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
        ...
        (node \ "@code-source").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@code-source" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "state-code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "code-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
        ...
        (node \ "@code-source").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@code-source" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "region-code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "code-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
        ...
        (node \ "@date").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@date" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "date" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "units" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "decimal-ch" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "thousands-ch" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_FracFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Frac] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Frac, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[com.gu.nitf.model.Numer](__obj.numer, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("numer"), __scope, false),
        __obj.fracSep map { scalaxb.toXML[com.gu.nitf.model.FracSep](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("frac-sep"), __scope, false) } getOrElse {Nil},
        scalaxb.toXML[com.gu.nitf.model.Denom](__obj.denom, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("denom"), __scope, false))
        ...
        (node \ "@gender").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[com.gu.nitf.model.Gender](x, scalaxb.ElemName(node) :: stack)) } map { "@gender" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "idsrc" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "value" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "gender" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_PostaddrFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Postaddr] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Postaddr, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[com.gu.nitf.model.Addressee](__obj.addressee, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("addressee"), __scope, false),
        __obj.deliveryPoint map { scalaxb.toXML[com.gu.nitf.model.DeliveryPoint](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("delivery.point"), __scope, false) } getOrElse {Nil},
        ...
        (node \ "@title").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@title" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "name" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "rel" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "rev" => Nil
        ...
        (node \ "@phonetic").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@phonetic" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "guide" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "phonetic" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_AddresseeFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Addressee] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Addressee, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[com.gu.nitf.model.Person](__obj.person, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("person"), __scope, false),
        __obj.function map { scalaxb.toXML[com.gu.nitf.model.FunctionType](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("function"), __scope, false) } getOrElse {Nil},
        __obj.careOf map { scalaxb.toXML[com.gu.nitf.model.CareOf](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("care.of"), __scope, false) } getOrElse {Nil})
      ...
      com.gu.nitf.model.DeliveryPoint(Seq.concat(p1.toList,
        ...
        (node \ "@code-source").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@code-source" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "point-code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "code-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
      ...
      com.gu.nitf.model.DeliveryOffice(Seq.concat(p1.toList,
        ...
        (node \ "@code-source").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@code-source" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "office-code" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "code-source" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
  ...
  trait DefaultComgunitfmodel_BodyEndFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.BodyEnd] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.BodyEnd, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.tagline map { scalaxb.toXML[com.gu.nitf.model.Tagline](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("tagline"), __scope, false) } getOrElse {Nil},
        __obj.bibliography map { scalaxb.toXML[com.gu.nitf.model.Bibliography](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("bibliography"), __scope, false) } getOrElse {Nil},
        __obj.any flatMap { x => scalaxb.toXML[scalaxb.DataRecord[Any]](x, x.namespace, x.key, __scope, true) })
  ...
  trait DefaultComgunitfmodel_NitfTableFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.NitfTable] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.NitfTable, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[com.gu.nitf.model.NitfTableMetadata](__obj.nitfTableMetadata, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("nitf-table-metadata"), __scope, false),
      ...
      case node: scala.xml.Node => Right(com.gu.nitf.model.TableReference(scala.collection.immutable.ListMap(List(
        ...
        (node \ "@idref").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@idref" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "id" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "idref" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_NitfTableMetadataFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.NitfTableMetadata] {
        ...
        (node \ "@row-count").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@row-count" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.PrefixedAttribute(pre, key, value, _) if pre == elem.scope.getPrefix("http://www.w3.org/XML/1998/namespace") &&
                key == "lang" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "subclass" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "idsrc" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "value" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "status" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "column-count" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "row-count" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.NitfTableMetadata, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.nitfTableSummary map { scalaxb.toXML[com.gu.nitf.model.NitfTableSummary](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("nitf-table-summary"), __scope, false) } getOrElse {Nil},
  ...
  trait DefaultComgunitfmodel_NitfTableSummaryFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.NitfTableSummary] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.NitfTableSummary, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.p flatMap { scalaxb.toXML[com.gu.nitf.model.P](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("p"), __scope, false) })
        ...
        (node \ "@occurrences").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@occurrences" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "idsrc" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "value" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "occurrences" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
  ...
  trait DefaultComgunitfmodel_NitfColgroupSequence1Format extends scalaxb.XMLFormat[com.gu.nitf.model.NitfColgroupSequence1] {
    ...
    def writes(__obj: com.gu.nitf.model.NitfColgroupSequence1, __namespace: Option[String], __elementLabel: Option[String], 
        __scope: scala.xml.NamespaceBinding, __typeAttribute: Boolean): scala.xml.NodeSeq =
      scalaxb.toXML[com.gu.nitf.model.NitfCol](__obj.nitfCol, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("nitf-col"), __scope, false)
        ...
        (node \ "@data-format").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@data-format" -> _ }
          ...
          case elem: scala.xml.Elem =>
            elem.attributes.toList flatMap {
              ...
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "value" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "occurrences" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "data-type" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) if key == "data-format" => Nil
              case scala.xml.UnprefixedAttribute(key, value, _) =>
                List(("@" + key, scalaxb.DataRecord(None, Some(key), value.text)))
              case scala.xml.PrefixedAttribute(pre, key, value, _) =>
                val ns = elem.scope.getURI(pre)
