...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  trait DefaultComgunitfmodel_NitfFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Nitf] {
    ...
    override def writesAttribute(__obj: com.gu.nitf.model.Nitf, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      ...
      attr = scala.xml.Attribute(null, "version", "-//IPTC//DTD NITF 3.4//EN".toString, attr)
      attr = scala.xml.Attribute(null, "change.date", "October 18, 2006".toString, attr)
      attr = scala.xml.Attribute(null, "change.time", "19:30".toString, attr)
      attr
    }
  ...
  trait DefaultComgunitfmodel_MediaFormat extends scalaxb.ElemNameParser[com.gu.nitf.model.Media] {
    ...
    def writesChildNodes(__obj: com.gu.nitf.model.Media, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.mediaMetadata flatMap { scalaxb.toXML[com.gu.nitf.model.MediaMetadata](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-metadata"), __scope, false) },
        ...
        __obj.mediaProducer map { scalaxb.toXML[com.gu.nitf.model.MediaProducer](_, Some("http://iptc.org/std/NITF/2006-10-18/"), Some("media-producer"), __scope, false) } getOrElse {Nil})
